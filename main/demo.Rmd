...
Internally, `covarem()` is doing multiple restarts of `covarem_once()` and
choosing the model that had the smallest penalized likelihood value.
...
## Now, run the CV loop
la()
cvres = cv.covarem(ylist=ylist, X=X, numclust=numclust,
